    ...
    <section id="team" className="py-20 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="team-circuit" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center space-x-2 bg-[#dfaa1a]/10 border border-[#dfaa1a]/30 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-[#dfaa1a] text-sm font-medium">Our Team Structure</span>
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Tim profesional berpengalaman dengan spesialisasi mendalam dalam teknologi cutting-edge, 
            berkomitmen memberikan solusi inovatif untuk setiap tantangan digital.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-20">
          {team.structure.map((member, index) => {
            ...
            return (
              <Card key={index} className={`group bg-gradient-to-br from-gray-900/80 to-black/80 border-2 ${borderColor} backdrop-blur-lg shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 overflow-hidden`}>
                ...
                <CardHeader className="relative overflow-hidden pb-6">
                  ...
                  <div className="relative z-10 flex items-center gap-4">
                    <div className={`p-4 bg-gradient-to-r ${gradient} rounded-2xl group-hover:scale-110 transition-all duration-300 shadow-lg`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      {member.responsibilities.map((responsibility, respIndex) => (
                        <div key={respIndex} className="flex items-center gap-3 p-3 bg-gray-800/50 rounded-lg border border-gray-700/50 group-hover:border-[#dfaa1a]/20 transition-all duration-300">
                          <CheckCircle className="h-4 w-4 text-[#dfaa1a] flex-shrink-0" />
                          <span className="text-gray-300 text-sm font-medium">{responsibility}</span>
                        </div>
                      ))}
                    </div>
                  </div>
          ...
          <div className="bg-gradient-to-r from-gray-900/80 to-black/80 backdrop-blur-lg border border-[#dfaa1a]/20 rounded-2xl p-8 lg:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Bergabunglah dengan tim elite teknologi dan jadilah bagian dari revolusi digital 
                yang mengubah cara dunia berinteraksi dengan teknologi.
              </p>
